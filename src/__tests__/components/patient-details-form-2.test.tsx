...
describe("PatientDetailsForm create type", () => {
	it("renders 'Enviar e Continuar' for create type", () => {
		render(
			<PatientDetailsForm
				userId="u-1"
	...
	it("renders identification and consent sections for create type", () => {
		render(
			<PatientDetailsForm
				userId="u-1"
				userEmail="test@test.com"
		...
		expect(screen.getByText("identification-section")).toBeInTheDocument();
		expect(screen.getByText("consent-section")).toBeInTheDocument();
	});

	it("hides identification and consent sections for edit type", () => {
		render(
			<PatientDetailsForm
				userId="u-1"
				userEmail="test@test.com"
		...
		expect(
			screen.queryByText("identification-section"),
		).not.toBeInTheDocument();
		expect(screen.queryByText("consent-section")).not.toBeInTheDocument();
	});
});
