...
import { ProfessionalCardInfo } from "@/components/custom/professional/ProfessionalCardInfo";
...
describe("ProfessionalCardInfo", () => {
	it("renders rating when provided", () => {
		render(<ProfessionalCardInfo professional={baseProfessional as never} />);
	...
	it("does not render rating row when rating is null", () => {
		const doc = { ...baseProfessional, rating: null };
	...
	it("does not render phone when absent", () => {
		const doc = { ...baseProfessional, phone: null };
		render(<ProfessionalCardInfo professional={doc as never} />);
	...
	it("does not render license when absent", () => {
		const doc = { ...baseProfessional, licenseNumber: null };
		render(<ProfessionalCardInfo professional={doc as never} />);
