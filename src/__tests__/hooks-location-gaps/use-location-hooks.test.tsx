...
import { useClinicsLocation } from "@/hooks/use-clinics-location";
import { useLabLocation } from "@/hooks/use-lab-location";
import { useProfessionalsLocation } from "@/hooks/use-professionals-location";
