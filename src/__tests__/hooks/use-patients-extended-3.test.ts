...
import { useUpdateMedicalRecords } from "@/features/patients/hooks/use-update-medical-records";
import { useUpdateMyProfile } from "@/features/patients/hooks/use-update-my-profile";
