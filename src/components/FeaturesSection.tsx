...
import { areasData } from "@/utils/constants/area";
		...
		<section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-background to-background/80">
			<div className="container px-4 md:px-6">
				...
				<p className="mx-auto max-w-[700px] text-center text-muted-foreground mb-8">
					Descubra como o ConsultaFácil simplifica o agendamento de consultas
					médicas em diversas especialidades.
				</p>
										...
										<Card className="hover:shadow-lg transition-all duration-300 overflow-hidden group relative">
											...
											<CardContent className="text-center">
												<p className="text-sm text-muted-foreground mb-4">
													Encontre o melhor profissional da área de{" "}
													{area.name.toLowerCase()} para você
												</p>
												<Link
													href={`/professionals?specialty=${encodeURIComponent(area.name)}`}
												>
													<Button
														variant="outline"
														size="sm"
