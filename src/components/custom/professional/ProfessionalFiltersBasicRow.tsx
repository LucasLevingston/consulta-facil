...
import { ProfessionalFiltersSelects } from "./ProfessionalFiltersSelects";
...
export function ProfessionalFiltersBasicRow({ filters }: Props) {
	return (
		<div className="flex flex-wrap gap-2 items-center">
			...
			<ProfessionalFiltersSelects filters={filters} />
			<Button
				variant="outline"
				size="sm"
