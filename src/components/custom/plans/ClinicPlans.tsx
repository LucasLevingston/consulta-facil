...
import { Building2, CheckCircle2, Crown, Minus, Plus, Star, Users, Zap } from "lucide-react";
...
function calcMonthlyPrice(totalDoctors: number): number {
  ...
  return BASE_PRICE * (1 + extra * 0.15);
}
...
const CLINIC_PLANS: Plan[] = [
  ...
  },
  {
    id: "clinic-yearly",
    title: "Clínica Anual",
    monthlyEquiv: fmtBRL(BASE_PRICE * 0.833),
    totalPrice: fmtBRL(BASE_PRICE * 12 * 0.833),
    period: "/ano",
    ...
    features: [
      ...
      `Economia de R$ ${fmtBRL(BASE_PRICE * 12 * 0.167)}/ano`,
              ...
              {isFree ? (
                <>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    {calcDoctors * FREE_CONSULTS_PER_DOCTOR} consultas gratuitas incluídas
                  </p>
                </>
              ) : (
                <>
