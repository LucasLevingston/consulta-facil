...
export function LocationPicker({ lat, lng, onLocationSelect, className }: LocationPickerProps) {
  return (
    <div className={className ?? "space-y-2"}>
      ...
      <div className="h-[300px] w-full border rounded-lg overflow-hidden">
        <LocationPickerInner lat={lat} lng={lng} onLocationSelect={onLocationSelect} />
      </div>
      {lat != null && lng != null && (
