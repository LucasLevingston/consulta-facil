...
import { useAllAdminAppointments } from "@/components/appointments/hooks";
...
function PaymentsContent() {
	...
	const { data, isLoading, error } = useAllAdminAppointments(page, PAGE_SIZE);
	...
	const appointments = allAppointments.filter((a) => {
		const matchesSearch =
			...
			a.professionalName?.toLowerCase().includes(debouncedSearch.toLowerCase());
	...
	return (
		<div className="space-y-6">
			<PageHeader
				title="Pagamentos"
				description="Histórico de pagamentos de toda a plataforma."
